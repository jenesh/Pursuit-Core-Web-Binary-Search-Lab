...
4. Give an array of words find if a target word like 'certain' is in the array using binary search. Your function should return the index at which the target word was found and -1 otherwise.
